    ...
    <div class="container">
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ma" DataSourceID="SqlDataSource3" EnableModelValidation="True" InsertItemPosition="LastItem">
            <AlternatingItemTemplate>
                <li style="background-color: #FFF8DC;">Mã Hóa Đơn(*):
            ...
            <EditItemTemplate>
                <li style="background-color: #008A8C;color: #FFFFFF;">Mã Hóa Đơn(*):
...
<br />
            ...
            <ItemTemplate>
                <li style="background-color: #DCDCDC;color: #000000;">Mã Hóa Đơn(*):
                    <asp:Label ID="maLabel" runat="server" Text='<%# Eval("ma") %>' />
                    <br />
                    Số Hóa Đơn:
                    <asp:Label ID="so_hoa_donLabel" runat="server" Text='<%# Eval("so_hoa_don") %>' />
            ...
            <SelectedItemTemplate>
                <li style="background-color: #008A8C;font-weight: bold;color: #FFFFFF;">Mã Hóa Đơn(*):
                    <asp:Label ID="maLabel" runat="server" Text='<%# Eval("ma") %>' />
                    <br />
                    Số Hóa Đơn:
                    <asp:Label ID="so_hoa_donLabel" runat="server" Text='<%# Eval("so_hoa_don") %>' />

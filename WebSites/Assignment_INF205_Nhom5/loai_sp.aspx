...
<head id="Head1" runat="server">
    ...
    <title>F5 Shop Group | Quản lý Loại SP</title>  
    ...
    <div class="container">
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ma" DataSourceID="SqlDataSource3" EnableModelValidation="True" InsertItemPosition="LastItem">
            <AlternatingItemTemplate>
                <li style="background-color: #FFF8DC;">Mã LSP(*):
            ...
            <EditItemTemplate>
                <li style="background-color: #008A8C;color: #FFFFFF;">Mã LSP:
...
<br />
            ...
            <ItemTemplate>
                <li style="background-color: #DCDCDC;color: #000000;">MÃ LSP:
                    <asp:Label ID="maLabel" runat="server" Text='<%# Eval("ma") %>' />
                    <br />
                    Tên LSP:
                    <asp:Label ID="ten_loai_san_phamLabel" runat="server" Text='<%# Eval("ten_loai_san_pham") %>' />
            ...
            <SelectedItemTemplate>
                <li style="background-color: #008A8C;font-weight: bold;color: #FFFFFF;">Mã LSP:
                    <asp:Label ID="maLabel" runat="server" Text='<%# Eval("ma") %>' />
                    <br />
                    Tên LSP:
                    <asp:Label ID="ten_loai_san_phamLabel" runat="server" Text='<%# Eval("ten_loai_san_pham") %>' />
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:data %>" DeleteCommand="DELETE FROM [loai_san_pham] WHERE [ma] = @ma" InsertCommand="INSERT INTO [loai_san_pham] ([ma], [ten_loai_san_pham]) VALUES (@ma, @ten_loai_san_pham)" SelectCommand="SELECT * FROM [loai_san_pham]" UpdateCommand="UPDATE [loai_san_pham] SET [ten_loai_san_pham] = @ten_loai_san_pham WHERE [ma] = @ma">
            <DeleteParameters>
                    ...
                    <div class="item">
                        <div class="row box-testimonial">
                            ...
                            <div class="col-xs-9 col-sm-9 col-md-10 box-text">
                                <blockquote>
                                    <p>
                                        Giao hàng rất nhanh và đúng giờ, chúc các bạn bán ahngf tốt</p>
                                    <footer>Lãng khách <cite title="Source Title">F5 Shop</cite></footer>
                                </blockquote>
                            </div>
                        </div>
